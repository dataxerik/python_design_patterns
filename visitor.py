class House(object):  # The class being visited
    def accept(self, visitor):
        ...
        visitor.visit(self)  # Trigger the visiting operation
    ...
    def work_on_electricity(self, electrician):
        print(self, "worked on by",
              electrician)  # Note that we now have a reference to the electrician in the house object!
...
class Electrician(Visitor):
    """Concentrate visitor, electrician"""
